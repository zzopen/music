...
const items: ItemType[] = reactive([
  getMenuItem('本地歌曲', '1', h(DesktopOutlined)),
  getMenuItem('下载歌曲', '2', h(CloudDownloadOutlined)),
  getMenuItem('本地歌曲', '3', h(FieldTimeOutlined))
])
...
const onClickMenuItem = ({ item, key, selectedKeys }) => {
