...
const URL_SONGSHEET_LIST = '/songsheet/songList'
const API_URL_URL_SONGSHEET_LIST: ApiDescription = {
  desc: '歌单列表',
  url: URL_SONGSHEET_SONG_LIST,
  method: METHOD.GET
}
...
export {
  URL_SONGSHEET_SONG_LIST,
  API_URL_SONGSHEET_SONG_LIST,
  URL_SONGSHEET_LIST,
  API_URL_URL_SONGSHEET_LIST
}
