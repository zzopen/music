...
const LOGIN_COMPONENT = () => import("@/views/default/login/index.vue");
const EXCEPTION_COMPONENT = () => import("@/views/default/exception/index.vue");
const LAYOUT_COMPONENT = () => import("@/components/layout/index.vue");
