<template>
   <div class="play-progress">
      <a-slider v-model:value="progress" :disabled="disabled" :tooltip-visible="tooltipVisible" v-bind="aSliderProps" @change="onChangeProgress" :tip-formatter="formatter"></a-slider>
   </div>
</template>
...
const progress = ref()
watch(() => playerStore.playProgress, (newVal) => {
