import type { Song, PlayList } from "@/business/typings";
...
interface PlayListState {
  ...
  curPlayListPosition: number; // 当前歌曲索引
}
...
export type { MixState, PlayerState, PlayListState };
